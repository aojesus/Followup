		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Relatorio de Solicitações de Cotações",
									"targetURL": "#comprestativslcfollowup-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comprestativslcfollowup-display": {
								"semanticObject": "comprestativslcfollowup",
								"action": "display",
								"description": "Relatorio de Solicitações de Cotações",
								"title": "Relatorio de Solicitações de Cotações",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.prestativ.slc.followup",
									"url": sap.ui.require.toUrl("com/prestativ/slc/followup")
								}
							}
						}
					}
